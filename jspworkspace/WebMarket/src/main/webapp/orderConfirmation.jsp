...
<%
	...
	Cookie[] cookies = request.getCookies(); //cookies 객체 선언(생성)
...
<body>
	...
	<div>
		...
		<%
			int sum = 0;
			ArrayList<Product> cartList = (ArrayList<Product>) session.getAttribute("cartlist"); //getAttribute의 반환값은 object형이므로 다운캐스팅해서 형변환
			if (cartList == null)
